  ...
  return (
    ...
    <div>
      ...
      <div  className='mb-10'>
        ...
        <button className='md:w-1/4  relative border-0 border-solid rounded text-center px-10 h-9 cursor-pointer bg-violet-900  hover:bg-opacity-70 text-white outline-none md:mt-8 mt-4'>Trade Now <img src={Arrow} alt="" className='ml-2 absolute md:bottom-2  bottom-2 md:right-4 right-3' /></button> 
      </div>
    </div>
    </div>
  );
